...
public class ConvolutionNode extends Node1To1 {
    ...
    public ConvolutionNode setActivationFunction(Function f) {
    ...
    protected void abs_calcOutputDim() throws BuildException {
        ...
        this.setOutputWidth((this.get_previous_node().getOutputWidth() + this.padding * 2 - filter_size) / filter_Stride + 1);
